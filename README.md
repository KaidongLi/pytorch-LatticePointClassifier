...
This repo is the official implementation for our CVPR 2022 paper **Robust Structured Declarative Classifiers for 3D Point Clouds: Defending Adversarial Attacks with Implicit Gradients**. 
