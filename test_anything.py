...
# points = np.load('../data/test/test/shapenet/shapenet_pc/shapenet-55_shapenet_pc_02691156-103c9e43cdf6501c62b600da24e0965.npy')
...
#                     encoder_dims=256
#                 )
# encoder_pt.load_state_dict(torch.load('checkpoints/foundation_pc_encoder_ulip_pointbert_pointtransformer8192.pth', map_location ='cpu'))
# encoder_pt.to('cuda')

# feat_pt = encoder_pt(torch.from_numpy(points[None]).type(torch.FloatTensor).to('cuda'))
...
x = preprocess(download_image('https://assets.bwbx.io/images/users/iqjWHBFdfxIU/iKIWgaiJUtss/v2/1000x-1.jpg')).to('cuda')
